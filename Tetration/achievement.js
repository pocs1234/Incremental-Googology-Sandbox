...
,GetAchievementTooltip = ()=>[
   [
      'Buy a (0)[2].<br>Reward: (0)[2] is 10x stronger'
      ,'Buy a (0)(0)[2].<br>Reward: zero-only 2 BM are 10x stronger'
      ,"Buy a (0)(0)(0)[2].<br>Reward: All unlockers boost zero-only BM 10x more"
      ,"Buy 4 (0)[2]'s at once. Reward: (0)[2] is 10x stronger"
      ,"Have 4 (0)(0)(0)[2]'s without seeing (0)(0)(0)(0)[2].<br>Reward: (0)(0)(0)[2] is 10x stronger"
      ,'Display your number as "ee...e" without any other symbol.<br>Reward: All zero-only BM are 27.1828% stronger'
      ,'Get multipliers of (0)[2] < (0)(0)[2] < (0)(0)(0)[2] < ...<br>Reward: zero-only 2 BM are 10x stronger'
      ,'Get amounts of (0)[2] < (0)(0)[2] < (0)(0)(0)[2] < ...<br>Reward: zero-only 2 BM are 10x stronger'
      ,'Have multiplier exceeding amount of every zero-only base-2 BM over 4.<br>Reward: zero-only 2 BM are 10x stronger'
   ],[
      'Buy a (0)(0)(0)(0)[2].<br>Reward: (0)(0)(0)(0)[2] is 10x stronger'
      ,'Buy a (0)(0)(0)(0)(0)(0)[2].<br>Reward: (0)(0)(0)(0)(0)(0)[2] is 10x stronger'
      ,'Buy a (0)(0)(0)(0)(0)(0)(0)(0)[2].<br>Reward: (0)(0)(0)(0)(0)(0)(0)(0)[2] is 10x stronger'
      ,'Have 18 different kinds of zero-only BM.<br>Reward: All zero-only BM are stronger based on time in this FGH'
      ,'Unlock 999 times in total.<br>Reward: zero-only BM are 99.9% stronger'
      ,'Boost (0)[2] by 65536× from unlocker.<br>Reward: zero-only 3 BM are 10x stronger'
      ,'Buy a (0)(0)(0)(0)(0)(0)(0)[2] without seeing (0)(0)[3].<br>Reward: (0)(0)(0)(0)(0)(0)(0)[2] is 10x stronger'
      ,'Unlock with only (0)[2] and highest zero-only base-2 BM bought.<br>Reward: (0)(0)[2] is 10x stronger'
      ,'Get multipliers of all zero-only base-2 BM (at least 4 of them) equal.<br>Reward: zero-only 2 BM are 10x stronger'
   ],[
      'Buy a (0)(0)[3].<br>Reward: (0)(0)[3] is 10x stronger'
      ,'Buy a (0)(0)(0)(0)(0)[3].<br>Reward: (0)(0)(0)(0)(0)[3] is 10x stronger'
      ,'Make the least multiplier of zero-only base-3 BM larger than any zero-only base-2 BM.<br>Reward: zero-only 3 BM are 10x stronger'
      ,'Make the least amount of zero-only base-3 BM larger than any zero-only base-2 BM.<br>Reward: zero-only 3 BM are 10x stronger'
      ,'Unlock zero-only base-3 BM more times than base-2.<br>Reward: zero-only 3 BM are 10x stronger'
      ,'Unlock zero-only base-3 BM with only (0)[2] and highest zero-only base-3 BM bought.<br>Reward: (0)(0)(0)[3] is 10x stronger'
      ,'Get multipliers of all base-2 and base-3 BM (at least 7 of them) equal.<br>Reward: multipliers when buying zero-only base-3 BM 10% stronger'
      ,'Buy a (0)(0)(0)[4].<br>Reward: zero-only 4 BM are 10x stronger'
      ,'Get multipliers of all zero-only base-2 and base-4 BM (at least 7 of them) equal.<br>Reward: multipliers when buying base-2 and base-4 BM 10% stronger'
   ],[
      'FGH-prestige.<br>Reward: get 5% more FGH number'
      ,'Get the 4 automatons from FGH challenge.<br>Reward: get 20% more FGH number'
      ,'Get ×160 from f<sub>0</sub><sup>m</sup>(n).<br>Reward: get 50% more FGH number'
      ,'Make your number grow less than 1e-100 (but not zero) per second.<br>Reward: get 10% more FGH number'
      ,'FGH-prestige with number between e1000 (including) and e1001.<br>Reward: get 10x more FGH number'
      ,'FGH-prestige with only (0)[2].<br>Reward: (0)[2] is a googol times stronger'
      ,'Complete FGH challenge 5 while unalum is bought.<br>Reward: get 10x more FGH number'
      ,'Complete FGH challenge 3 under one minute.<br>Reward: get 10x more FGH number'
      ,'Get equal (1% margin) bonus from f<sub>2</sub>(n) and all bought f<sub>1</sub><sup>m</sup>(n).<br>Reward: get 10x more FGH number'
   ]
]
,AchievementOn = ()=>{
...
,Row0watch = ()=>{
   ...
   if(!(Achievement[0]&256))
      Cancel[8]=v.$watch(()=>{
         ...
         while(n--) if(!(LessQ(8.000000000001,amount[n])&&LessQ(amount[n],mult[n]))) return false;
         return true
      },x=>{
         if(!x) return;
         Cancel[8]();
...
,Row1watch = ()=>{
   ...
   if(!(Achievement[1]&16))
      Cancel[13]=v.$watch(()=>v.BM0etcUnlockTotal>=999,x=>{
         if(!x) return;
         Cancel[13]();
